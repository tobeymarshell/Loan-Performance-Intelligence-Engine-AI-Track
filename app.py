...
tab_app, tab_report = st.tabs(["🏦 Loan Intelligence Engine", "📈 Data Profiling Report"])
...
with tab_report:
    if has_report:
        ...
        st.warning("⚠️ Report not found. Please run loan_intelligence_engine.py first.")
